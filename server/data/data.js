export const kpis = [
    {
      ...
      dailyData: [
        ...
        { date: "2023-01-01", revenue: "$536.87", expenses: "$256.78" },
        { date: "2023-01-02", revenue: "$865.85", expenses: "$125.75" },
        { date: "2023-01-03", revenue: "$8524.52", expenses: "$52.15" },
        { date: "2023-01-04", revenue: "$523.22", expenses: "$745.48" },
        { date: "2023-01-05", revenue: "$585.32", expenses: "$963.14" },
        { date: "2023-01-06", revenue: "$745.11", expenses: "$333.13" },
        { date: "2023-01-07", revenue: "$653.23", expenses: "$563.11" },
        { date: "2023-01-08", revenue: "$214.14", expenses: "$123.78" },
        { date: "2023-01-09", revenue: "$567.45", expenses: "$213.44" },
        { date: "2023-01-10", revenue: "$963.14", expenses: "$525.52" },
      ],
      expensesByCategory: {
        salaries: "$38000.00",
        supplies: "$13000.00",
